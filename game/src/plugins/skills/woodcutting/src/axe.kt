...
enum class Axe(val id: Int, val level: Int, val animation: Animation, val pulses: Int) {
    RUNE(1275, 41, Animation(867), 3),  // rune
    ADAMANT(1271, 31, Animation(869), 4), // adamant
    MITHRIL(1273, 21, Animation(871), 5), // mithril
    BLACK(0, 11, Animation(873), 6),  // steel
    STEEL(1269, 6, Animation(875), 6),  // steel
    ITRON(1267, 1, Animation(877), 7),  // iron
    BRONZE(1265, 1, Animation(879), 8)  // bronze
}
