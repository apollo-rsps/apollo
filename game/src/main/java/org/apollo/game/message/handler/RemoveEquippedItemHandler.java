 ...
 * @author Major
 */
public final class RemoveEquippedItemHandler extends MessageHandler<IfActionMessage> {
	...
	public void handle(Player player, IfActionMessage message) {
		if (message.getOption() == 1
				&& message.getInterfaceId() == SynchronizationInventoryListener.EQUIPMENT_ID) {
