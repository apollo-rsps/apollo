...
enum class FishingTool(
    ...
    FISHING_ROD("You attempt to catch a fish...", id = 307, animation = 622, bait = 313, baitName = "fishing bait"),
    FLY_FISHING_ROD("You attempt to catch a fish...", id = 309, animation = 622, bait = 314, baitName = "feathers");
